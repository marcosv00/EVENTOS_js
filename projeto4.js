...
function adicionar() {
  var div = document.createElement("div"); // criando um elemnto do tipo "div"
  div.className = "quadrado";
  div.style.backgroundColor = "rgb(100,100,100)";
  container.appendChild(div);// vai adicionar na div conteiner um novo filho e esse filho é a "div"
}
